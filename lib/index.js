...
app.listen(PORT, '0.0.0.0', () => {
  console.log(`WipeBot gestartet auf Port ${PORT} auf allen Schnittstellen – DEBUG_MODE: ${DEBUG_MODE}`);
  logDebug(`🚀 Server gestartet auf Port ${PORT} auf allen Schnittstellen – Widget-URL: ${DEBUG_MODE ? 'https://dev.d-vicr.de/widget' : 'https://wipebot.d-vicr.de/widget'}`);
});