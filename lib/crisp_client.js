...
constructor() {
  ...
  // Erstelle Axios-Instance mit korrekten Authentifizierungsheadern
  ...
  this.api.interceptors.request.use(config => {
    if (this.DEBUG_MODE) {
      ...
      const maskedKey = auth.env.CRISP_API_KEY 
        ...
        : "undefined";
      logDebug(`🔑 Authentifizierungs-Headers: Authorization=Basic *****, X-Crisp-Tier=plugin`);
    }
    return config;
  });
  ...
  var authHeader = new Buffer(this.identifier + ':' + this.key).toString('base64');
  this.headers = {
